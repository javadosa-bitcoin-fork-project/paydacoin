...
#ifndef PAYDACOIN_UTIL_SYSCALL_SANDBOX_H
#define PAYDACOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during paydacoind initialization if Paydacoin Core was compiled
...
#endif // PAYDACOIN_UTIL_SYSCALL_SANDBOX_H
