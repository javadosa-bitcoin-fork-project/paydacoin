 ...
 */
#ifndef PAYDACOIN_UTIL_SYSTEM_H
#define PAYDACOIN_UTIL_SYSTEM_H
...
extern const char * const PAYDACOIN_CONF_FILENAME;
extern const char * const PAYDACOIN_SETTINGS_FILENAME;
