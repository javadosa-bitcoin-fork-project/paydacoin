...
#ifndef PAYDACOIN_UTIL_MESSAGE_H
#define PAYDACOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's paydacoin address, it must refer to a public key.
...
#endif // PAYDACOIN_UTIL_MESSAGE_H
