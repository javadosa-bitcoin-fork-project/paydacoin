...
#ifndef PAYDACOIN_SCRIPT_STANDARD_H
#define PAYDACOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a paydacoin address
 */
...
/**
 * Generate a Paydacoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // PAYDACOIN_SCRIPT_STANDARD_H
