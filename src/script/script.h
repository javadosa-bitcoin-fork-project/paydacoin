...
#ifndef PAYDACOIN_SCRIPT_SCRIPT_H
#define PAYDACOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Paydacoin always counted CHECKMULTISIGs
...
#endif // PAYDACOIN_SCRIPT_SCRIPT_H
