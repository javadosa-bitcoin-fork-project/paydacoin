...
#ifndef PAYDACOIN_KERNEL_CONTEXT_H
#define PAYDACOIN_KERNEL_CONTEXT_H

#include <memory>

namespace kernel {
//! Context struct holding the kernel library's logically global state, and
//! passed to external libpaydacoin_kernel functions which need access to this
...
#endif // PAYDACOIN_KERNEL_CONTEXT_H
