...
#ifndef PAYDACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define PAYDACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // PAYDACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
