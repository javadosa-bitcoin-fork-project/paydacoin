...
#ifndef PAYDACOIN_WALLET_SCRIPTPUBKEYMAN_H
#define PAYDACOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Paydacoin Core wallet was originally a collection of unrelated private
...
#endif // PAYDACOIN_WALLET_SCRIPTPUBKEYMAN_H
