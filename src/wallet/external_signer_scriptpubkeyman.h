...
#ifndef PAYDACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define PAYDACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // PAYDACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
