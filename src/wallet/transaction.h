...
#ifndef PAYDACOIN_WALLET_TRANSACTION_H
#define PAYDACOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this paydacoin node, and set to 0 for transactions that were created
...
#endif // PAYDACOIN_WALLET_TRANSACTION_H
