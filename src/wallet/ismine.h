...
#ifndef PAYDACOIN_WALLET_ISMINE_H
#define PAYDACOIN_WALLET_ISMINE_H
 ...
 * https://github.com/paydacoin/paydacoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // PAYDACOIN_WALLET_ISMINE_H
