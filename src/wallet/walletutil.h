// Copyright (c) 2017-2021 The Paydacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef PAYDACOIN_WALLET_WALLETUTIL_H
#define PAYDACOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! paydacoin from opening the wallet, thinking it was newly created, and
...
#endif // PAYDACOIN_WALLET_WALLETUTIL_H
