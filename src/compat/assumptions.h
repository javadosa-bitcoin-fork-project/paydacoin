...
#ifndef PAYDACOIN_COMPAT_ASSUMPTIONS_H
#define PAYDACOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Paydacoin cannot be compiled without assertions."
#endif
...
#endif // PAYDACOIN_COMPAT_ASSUMPTIONS_H
