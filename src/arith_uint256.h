...
#ifndef PAYDACOIN_ARITH_UINT256_H
#define PAYDACOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Paydacoin only uses this "compact" format for encoding difficulty
...
#endif // PAYDACOIN_ARITH_UINT256_H
