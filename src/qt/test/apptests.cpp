...
//! Entry point for PaydacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PaydacoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PaydacoinGUI tests.
void AppTests::guiTests(PaydacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PaydacoinGUI::consoleShown, this, &AppTests::consoleTests);
