...
{
    // Test regression https://github.com/paydacoin/paydacoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/paydacoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/paydacoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Paydacoin/Paydacoin-Qt.conf and all else left as default,
    // paydacoin-qt should set both -listen and -listenonion to false and start successfully.
