      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->paydacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->paydacoinAtStartup);
    ...
    ui->paydacoinAtStartup->setToolTip(ui->paydacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->paydacoinAtStartup->setText(ui->paydacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openPaydacoinConfButton->setToolTip(ui->openPaydacoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PaydacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->paydacoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSPDControls);
...
void OptionsDialog::on_openPaydacoinConfButton_clicked()
{
