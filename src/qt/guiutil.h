...
#ifndef PAYDACOIN_QT_GUIUTIL_H
#define PAYDACOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Paydacoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "paydacoin:" URI into recipient object, return true on successful parsing
