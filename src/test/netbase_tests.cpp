...
{
    BOOST_CHECK(TestSplitHost("www.paydacoincore.org", "www.paydacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.paydacoincore.org]", "www.paydacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.paydacoincore.org:80", "www.paydacoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.paydacoincore.org]:80", "www.paydacoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.paydacoincore.org:65536", "www.paydacoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.paydacoincore.org:0", "www.paydacoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.paydacoincore.org:", "www.paydacoincore.org:", 0, false));
}
