...
#ifndef PAYDACOIN_TEST_SCRIPTNUM10_H
#define PAYDACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Paydacoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PAYDACOIN_TEST_SCRIPTNUM10_H
