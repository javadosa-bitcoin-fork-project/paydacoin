...
#ifndef PAYDACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define PAYDACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // PAYDACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
