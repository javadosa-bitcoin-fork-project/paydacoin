...
#ifndef PAYDACOIN_INTERFACES_INIT_H
#define PAYDACOIN_INTERFACES_INIT_H
...
//! (paydacoin-gui, paydacoin-node, paydacoin-wallet, paydacoind, paydacoin-qt) and each
...
#endif // PAYDACOIN_INTERFACES_INIT_H
