...
#ifndef PAYDACOIN_INTERFACES_NODE_H
#define PAYDACOIN_INTERFACES_NODE_H
...
//! Top-level interface for a paydacoin node (paydacoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or paydacoin.conf.
...
#endif // PAYDACOIN_INTERFACES_NODE_H
