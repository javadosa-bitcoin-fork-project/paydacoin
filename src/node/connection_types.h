...
#ifndef PAYDACOIN_NODE_CONNECTION_TYPES_H
#define PAYDACOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/paydacoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Paydacoin’s Peer-to-Peer Network")
...
#endif // PAYDACOIN_NODE_CONNECTION_TYPES_H
