...
{
    const char* pszTimestamp = "Payda coin started at 09/Mar/2023";
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.paydacoinstats.com."); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.paydacoin.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.pdc.petertodd.org."); // Peter Todd, only supports x1, x5, x9, and xd
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("seed.signet.paydacoin.sprovoost.nl.");
