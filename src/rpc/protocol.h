...
#ifndef PAYDACOIN_RPC_PROTOCOL_H
#define PAYDACOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in paydacoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Paydacoin is not connected
...
#endif // PAYDACOIN_RPC_PROTOCOL_H
