Paydacoin Core version 0.9.2.1 is now available from:

  https://paydacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PDC to 0.01 PDC
...
- Fix "Start paydacoin on system login"
