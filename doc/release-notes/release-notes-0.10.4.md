Paydacoin Core version 0.10.4 is now available from:

  <https://paydacoin.org/bin/paydacoin-core-0.10.4/>
...
- #6953 `43c2789` Split paydacoin-tx into its own package
- #6953 `dfe0d4d` Include paydacoin-tx binary on Debian/Ubuntu
