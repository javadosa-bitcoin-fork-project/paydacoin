...
- Before this release, Paydacoin Core had a strong preference to try to connect only to peers that listen on port 8333. As a result of that, Paydacoin nodes listening on non-standard ports would likely not get any Paydacoin Core peers connecting to them. This preference has been removed. (#23542)
