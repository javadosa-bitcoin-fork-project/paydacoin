Paydacoin Core version 0.16.1 is now available from:

  <https://paydacoincore.org/bin/paydacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting paydacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure paydacoind processes are cleaned up when tests end (sdaftuar)
