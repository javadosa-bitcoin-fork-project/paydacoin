Paydacoin Core version 0.9.4 is now available from:

  https://paydacoin.org/bin/0.9.4/
...
this update is incompatible with the Paydacoin system and could lead to consensus
forks.

Paydacoin Core released binaries from https://paydacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~paydacoin/+archive/ubuntu/paydacoin
- A third-party or self-compiled Paydacoin Core

upgrade to Paydacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
