Paydacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/paydacoin/files/Paydacoin/paydacoin-0.5.4/
...
http://gitorious.org/paydacoin/paydacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Paydacoin-Qt notifications under Growl 1.3.
Increase required age of Paydacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPaydacoin properly when installing Paydacoin-Qt over it. (Windows)
