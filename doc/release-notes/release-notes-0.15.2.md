Paydacoin Core version *0.15.2* is now available from:

  <https://paydacoincore.org/bin/paydacoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in paydacoin-tx (TheBlueMatt)
