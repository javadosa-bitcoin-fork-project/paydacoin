Paydacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/paydacoin/files/Paydacoin/paydacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Paydacoin
...
New/changed settings (command-line or paydacoin.conf file)
--------------------------------------------------------
