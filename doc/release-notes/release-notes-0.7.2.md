Paydacoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/paydacoin/files/Paydacoin/paydacoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Paydacoin-Qt to crash on Windows when exiting.
