Paydacoin Core version *0.15.0.1* is now available from:

  <https://paydacoin.org/bin/paydacoin-core-0.15.0.1/>

and

  <https://paydacoincore.org/bin/paydacoin-core-0.15.0.1/>
