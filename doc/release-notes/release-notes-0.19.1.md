...
Paydacoin Core version 0.19.1 is now available from:

  <https://paydacoincore.org/bin/paydacoin-core-0.19.1/>
...
From Paydacoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Paydacoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Paydacoin Core does not yet change appearance when
...
- #17488 fix "paydacoind already running" warnings on macOS (fanquake)
