Paydacoin Core version 0.13.2 is now available from:

  <https://paydacoin.org/bin/paydacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update paydacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow paydacoin-tx to create v2 transactions (pdcdrak)
