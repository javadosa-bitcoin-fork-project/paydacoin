Paydacoin Core version *0.14.3* is now available from:

  <https://paydacoin.org/bin/paydacoin-core-0.14.3/>
...
Paydacoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #10451 `3612219` contrib/init/paydacoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
