...
This document provides guidelines for internationalization of the Paydacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `paydacoin_en.ts` remains unchanged.
