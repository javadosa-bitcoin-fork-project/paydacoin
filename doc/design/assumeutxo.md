...
Assumeutxo is a feature that allows fast bootstrapping of a validating paydacoind
...
- [Github issue](https://github.com/paydacoin/paydacoin/issues/15605)
- [draft PR](https://github.com/paydacoin/paydacoin/pull/15606)
...
considered active. This is the "traditional" mode of operation for paydacoind.
...
**Failure consideration:** if paydacoind unexpectedly halts after `m_stop_use` is set on
...
### Paydacoind restarts sometime after snapshot validation has completed

When paydacoind initializes again, what began as the snapshot chainstate is now
