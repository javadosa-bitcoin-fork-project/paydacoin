...
"""Script for verifying Paydacoin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
paydacoincore.org and paydacoin.org and compares them.
...
WORKINGDIR = "/tmp/paydacoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://paydacoincore.org"
HOST2 = "https://paydacoin.org"
VERSIONPREFIX = "paydacoin-core-"
...
def main(args):
    ...
    if not success:
        print("paydacoin.org failed to provide signature file, "
              "but paydacoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("paydacoin.org and paydacoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Paydacoin Core binary release "
