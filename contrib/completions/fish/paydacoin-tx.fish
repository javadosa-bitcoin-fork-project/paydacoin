...
# Extract options
function __fish_paydacoin_tx_get_options
...
# Extract commands
function __fish_paydacoin_tx_get_commands
...
# Add options
complete \
    --command paydacoin-tx \
    --condition "not __fish_paydacoin_seen_cmd (__fish_paydacoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_paydacoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command paydacoin-tx \
    --arguments "(__fish_paydacoin_tx_get_commands)" \
    --no-files
