...
complete --command paydacoind --no-files

# Extract options
function __fish_paydacoind_get_options
...
complete \
    --command paydacoind \
    --arguments "(__fish_paydacoind_get_options --nofiles)"
