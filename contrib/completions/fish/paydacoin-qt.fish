...
complete --command paydacoin-qt --no-files

# Extract options
function __fish_paydacoinqt_get_options
...
complete \
    --command paydacoin-qt \
    --arguments "(__fish_paydacoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c paydacoin-qt \
...
complete \
    --command paydacoin-qt \
    --arguments "(__fish_paydacoinqt_get_options --nofiles)"
