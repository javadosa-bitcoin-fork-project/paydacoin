...
"""Example logging Paydacoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/paydacoind
...
def main(paydacoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[paydacoind_with_usdts])
