...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef PAYDACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define PAYDACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the paydacoin network\n')
    ...
    g.write('#endif // PAYDACOIN_CHAINPARAMSSEEDS_H\n')
