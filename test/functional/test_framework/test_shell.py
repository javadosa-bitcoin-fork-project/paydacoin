...
class TestShell:
    """Wrapper Class for PaydacoinTestFramework.

    The TestShell class extends the PaydacoinTestFramework
    ...
    class __TestShell(PaydacoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PaydacoinTestFramework child class.
            self.num_nodes = 1
