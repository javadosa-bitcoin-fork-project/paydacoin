...
class TxnMallTest(PaydacoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 PDC:
        ...
        # First: use raw transaction API to send 1240 PDC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 PDC coin each
        ...
        # Node0's balance should be starting balance, plus 50PDC for another
        ...
        # Node0's total balance should be starting balance, plus 100PDC for
