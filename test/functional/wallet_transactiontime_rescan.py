...
class TransactionTimeRescanTest(PaydacoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine PDC and create transactions
        ...
        # generate some pdc to create transactions and check blockcount
        ...
        # send 10 pdc to user's first watch-only address
        self.log.info('Send 10 pdc to user')
        ...
        # send 5 pdc to our second watch-only address
        self.log.info('Send 5 pdc to user')
        ...
        # send 1 pdc to our third watch-only address
        self.log.info('Send 1 pdc to user')
