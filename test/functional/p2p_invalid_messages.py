#!/usr/bin/env python3
# Copyright (c) 2015-2021 The Paydacoin Core developers
...
class InvalidMessagesTest(PaydacoinTestFramework):
    ...
    def test_addrv2(self, label, required_log_messages, raw_addrv2):
        ...
        # Make sure paydacoind signals support for ADDRv2, otherwise this test
