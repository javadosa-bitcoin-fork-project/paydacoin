...
By default, paydacoind will dump mempool on shutdown and
...
class MempoolPersistTest(PaydacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent paydacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
