...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PaydacoinTestFramework
    pass


class ExampleTest(PaydacoinTestFramework):
    # Each functional test is a subclass of the PaydacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        PaydacoinTestFramework class so other tests can use it."""
