#!/usr/bin/env python3
# Copyright (c) 2021-2021 The Paydacoin Core developers
...
class I2PPorts(PaydacoinTestFramework):
    ...
    def run_test(self):
        ...
        addr = "zsxwyo6qcn3chqzwxnseusqgsnuw3maqnztkiypyfxtya4snkoka.b32.i2p:7333"
        raised = False
        try:
