...
Verify that a paydacoind node can use an external signer command.
...
class RPCSignerTest(PaydacoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart paydacoind with -signer=<cmd>',
