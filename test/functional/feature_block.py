...
class FullBlockTest(PaydacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure paydacoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure paydacoind isn't accepting b28
        ...
        # paydacoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the paydacoin code has custom code which does so);
