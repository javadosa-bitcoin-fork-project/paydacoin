...
"""
Test starting paydacoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(PaydacoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that paydacoind has bound on "::1" (for RPC) and "::" (for P2P).
