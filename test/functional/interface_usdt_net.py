...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/paydacoin/paydacoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(PaydacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our paydacoind node")
